...
const {
  getInscriptosPeriodos,
  getInscriptosPorPropuestaSede,
  getInscriptosSedeAnio,
  getInscriptosSedeCarreraTipoSexo,
  getInscriptosTanios,
  getInscriptosTotal,
  getInscriptosTotalSede,
  getIscriptosTipoIngresoSedeSexo,
  getIscriptosTipoIngresoSedeSexoCarrera
} = require('../controllers/inscriptosControllers');
