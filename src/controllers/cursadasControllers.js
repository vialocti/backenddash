import { cantidadExamenReprobados, recursa, regularidadVigente, traerCantidadporActividad, traerInscriptosSedeAnio, traerRechazadosBajaActividad, tratarExamenes } from '../services/cursadas/cursadasServices.js'
    ...
    try {
       ...
       setTimeout(()=>{
        datos.forEach(async element=>{
            element.propuesta= await traerPropuesta(element.codmat)
