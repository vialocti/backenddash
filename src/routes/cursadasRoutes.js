...
router.get('/detalleporcomisiones/:anio/:ncomisiones/:codsede/:recursado',resultadoActaDetallesporComisiones)

router.get('/actividadeshistoricos/:sede/:anioI', traerActividadesHistoricas)

router.get('/historicoIndice/:sede/:anioI/:anioF/:actividad', traerDatosHistoricosResultados)
