...
router.get('/actividadeshistoricos/:sede/:propuesta/:periodo/:anioI', traerActividadesHistoricas)

router.get('/historicoIndice/:sede/:propuesta/:periodo/:actividad/:anioI/:anioF', traerDatosHistoricosResultados)
